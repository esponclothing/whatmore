                            ...
                            <td>
                              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                <div>
                                  ...
                                  <span style={{ fontSize: '11px', color: '#64748b' }}>{log.actorEmail || 'system@esponsports.com'}</span>
                                </div>
                              </div>
                            </td>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', paddingTop: '16px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                  ...
                  <div style={{ background: '#f8fafc', padding: '10px 14px', borderRadius: '8px' }}>
                    ...
                    <strong style={{ fontSize: '13px', color: '#0f172a' }}>{selectedAuditLog.actorEmail || 'system@esponsports.com'}</strong>
                  </div>
                </div>
